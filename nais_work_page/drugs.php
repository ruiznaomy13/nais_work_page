...
<div class="titulo_drugs">
    ...
    <div class="container_grande_0">
        ...
        <div class="container_derecha">
                <a style="color:black" class="box_farmacos" href="new_drug.php">CREATE NEW</a>
            <br>
    ...
    <div class="container_grande">
        ...
        <div class="container_derecha">
            ...
            <div class="drugs">
                <a href="">
                    <img src="img/medicamentos/<?php echo $row["foto"]?>">
                </a>
            ...
            <form action="view_drug.php" method=get>
                <input type=submit class="botones" value="view">
                <input type=hidden name="accion" value=view>
                <input type=hidden name="code_drug" value=<?php echo $row["codigo"]?>>
            </form>
            <form action="edit_drug.php" method=get>
...
else if ($_GET["accion"] == "delete")
{
    ...
    $sql="DELETE FROM tfarmacos WHERE codigo=".$_GET['code_drug'].";";
    $resultado = mysqli_query($conexion, $sql);
