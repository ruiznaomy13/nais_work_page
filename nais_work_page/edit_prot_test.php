...
<?php
    ...
    if(is_uploaded_file($tmpimg)){
        ...
        $sql="UPDATE tproteinas SET nombre='".$_POST['name']."',foto='$foto_name',resolucion='".$_POST['resolucion']."',metodo='".$_POST['metodo']."',
        ...
        echo 'UPS! Algo ha fallado al actualizar la proteina.';
    }
